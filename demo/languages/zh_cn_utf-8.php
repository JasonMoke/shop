 ...
 * $Id: zh_cn_utf-8.php 16882 2009-12-14 09:22:19Z Jason $
*/

$_LANG['prev_step']         = '涓婁竴姝ワ細';
$_LANG['next_step']         = '涓嬩竴姝ワ細';
$_LANG['select_language_title']       =  'SHOP鍗囩骇绋嬪簭 绗?姝?鍏?姝 閫夋嫨璇?█缂栫爜';
$_LANG['readme_title']                =  'SHOP鍗囩骇绋嬪簭 绗?姝?鍏?姝 璇存槑椤?;
$_LANG['checking_title']                =  'SHOP鍗囩骇绋嬪簭 绗?姝?鍏?姝 鐜??妫€娴?;
$_LANG['check_system_environment']          = '妫€娴嬬郴缁熺幆澧?;

$_LANG['copyright']                     = '&copy; 2005-2011 <a href="http://www.SHOP.com" target="_blank">涓婃捣鍟嗘淳缃戠粶绉戞妧鏈夐檺鍏?徃</a>銆備繚鐣欐墍鏈夋潈鍒┿€?;
$_LANG['is_last_version']             = '鎮ㄧ殑SHOP宸叉槸鏈€鏂扮増鏈?紝鏃犻渶鍗囩骇銆?;

$_LANG['readme_page']                =  '璇存槑椤?;
$_LANG['notice'] = '鏈?▼搴忕敤浜庡皢 SHOP 鍗囩骇鍒 <strong>%s</strong>銆傝?鍕垮繀鎸夌収浠ヤ笅鐨勫崌绾ф柟娉曡繘琛屽崌绾э紝鍚﹀垯鍙?兘浜х敓鏃犳硶鎭㈠?鐨勫悗鏋溿€傚?鏋滀綘宸茬粡鏁村悎浜嗚?鍧涜蒋浠讹紝鏈??鍗囩骇灏嗗彇娑堟暣鍚堬紝浠ュ悗浼氬憳鏁村悎璇峰埌ucenrer涓?繘琛屾暣鍚堛€?;
...
$_LANG['usage3']  = '鍏抽棴鐜版湁鐨 SHOP %s 绯荤粺锛?;
$_LANG['usage4']  = '瑕嗙洊鎬т笂浼 SHOP %s 鐨勫叏閮ㄦ枃浠跺埌鏈嶅姟鍣?紱';
$_LANG['usage5']  = '涓婁紶鏈?▼搴忓埌 SHOP 鎵€鍦ㄧ殑鐩?綍涓?紱';
...
$_LANG['upgrade_error_title']                    = 'SHOP鍗囩骇绋嬪簭 鍗囩骇澶辫触';
$_LANG['upgrade_done_title'] = 'SHOP鍗囩骇绋嬪簭 鍗囩骇鎴愬姛';
$_LANG['go_to_view_my_SHOP'] = '鍓嶅線 SHOP 棣栭〉';
$_LANG['go_to_view_control_panel'] = '鍓嶅線 SHOP 鍚庡彴绠＄悊涓?績 ';
...
$_LANG['js_languages']['is_last_version']                   = '鎮ㄧ殑SHOP宸叉槸鏈€鏂扮増鏈?紝鏃犻渶鍗囩骇銆?;
...
$_LANG['ucip_intro'] = '杩炴帴鐨勮繃绋嬩腑鍑轰簡鐐归棶棰橈紝璇锋偍濉?啓鏈嶅姟鍣 IP 鍦板潃锛屽?鏋滄偍鐨 UC 涓 SHOP 瑁呭湪鍚屼竴鏈嶅姟鍣ㄤ笂锛屾垜浠?缓璁?偍灏濊瘯濉?啓 127.0.0.1';
...
$_LANG['lang_desc']['desc2'] = '濡傛灉鎮ㄧ殑鏁版嵁搴撲笌SHOP绋嬪簭缂栫爜涓嶄竴鑷达紝鍙?互鍏堣繘琛屾暟鎹?簱缂栫爜杞?崲銆?;
$_LANG['lang_desc']['desc3'] = '<font color="red">濡傛灉鎮ㄦ槸浠嶦CShop v2.6.0鐗堟湰杩涜?鍗囩骇锛屽苟閫夋嫨SHOP鎺ュ彛鏂瑰紡锛岃?鍏堣繘琛屼細鍛樻暟鎹?殑瀵煎叆锛屽惁鍒欏師浼氬憳灏嗘棤娉曠櫥褰曘€侟/font>';

/* 鐢ㄦ埛鎺ュ彛鎻掍欢璇?█椤 */
$_LANG['ui_title'] = '璇烽€夋嫨SHOP浣跨敤鐨勭敤鎴锋帴鍙ｆ彃浠?;
