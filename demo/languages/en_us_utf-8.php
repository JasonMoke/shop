<?php
/**
 * SHOP Upgrade program language file
 * ============================================================================
 ...
 * $Id: en_us.php 15163 2009-06-26 10:51:04Z Jason $
*/
$_LANG['prev_step'] = 'Previous:';
$_LANG['next_step'] = 'Next:';
$_LANG['select_language_title']='SHOP upgrade program, the 1 step / 3 steps, Select language and charset';
$_LANG['readme_title'] = 'SHOP upgrade program, the 2 step / 3 steps, readme page';
$_LANG['checking_title'] = 'SHOP upgrade program, the 3 step / 3steps, check environment';
$_LANG['check_system_environment'] = 'Check system environment';

$_LANG['copyright'] = '&copy; 2005-2011 <a href="http://www.SHOP.com" target="_blank">Shanghai ShopEx Network Technology Co,.Ltd. </a>. All right reserved';
$_LANG['is_last_version'] = 'Your SHOP has been the newest version, needn\'t upgrade.';

$_LANG['readme_page'] = 'Readme page';
$_LANG['notice'] = 'The program will upgrade SHOP to <strong>%s</strong>. Please upgrade by this way, otherwise the result can\'t be restore possibility.';
...
$_LANG['usage2'] = 'Close old SHOP %s system;';
$_LANG['usage3'] = 'Upload SHOP %s all files to your server;';
$_LANG['usage4'] = 'Upload the program to SHOP higher directory;';
...
$_LANG['done'] = 'Congratulation, system has be upgraded SHOP <strong>%s</strong>';
$_LANG['upgrade_error_title'] = 'SHOP upgrade program, upgrade failed.';
$_LANG['upgrade_done_title'] = 'SHOP upgrade program, upgrade successfully.';
...
$_LANG['js_languages']['is_last_version'] = 'Your SHOP has been the newest version, needn\'t upgrade.';
...
$_LANG['ucip_intro'] = 'Some errors to connect,please input the server IP address,if you have UC and SHOP mounted on the same server, we recommend that you try to fill in 127.0.0.1';
...
$_LANG['ucenter_not_match'] = '<span style="color:#F00;font-size:1.2em;"><b>UCenter\'s charset and SHOP\'s charset are different,upgrade can not be completed, please contact administrator!</b></span>';

/* 璇?█瀛楃?闆嗛€夋嫨 */
$_LANG['lang_title'] = 'SHOP\'s language and charset';
...
$_LANG['lang_desc']['desc1'] = 'Make sure SHOP\'s language and charset are same as your choice;';
$_LANG['lang_desc']['desc2'] = 'If your database\'s charset is different with SHOP program\'s charset,please covert database \'s charset first';
$_LANG['lang_desc']['desc3'] = '<font color="red">If you upgrade from SHOP v2.6.0 version, and select SHOP interface mode, first import the data to members, or former member will not be able to login.</font>';


/* 鐢ㄦ埛鎺ュ彛鎻掍欢璇?█椤 */
$_LANG['ui_title'] = 'Please select the user interface plug-ins of SHOP';
$_LANG['ui_SHOP'] = 'SHOP type';
